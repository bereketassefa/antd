...
const navigations = [
    {label: "Home",
    icon: <AiOutlineHome className='mx-auto text-[30px]' />},
    {label: "Notifcation",
...
function Icon ({label, icon}) {
    return (
        <div className="opacity-70 px-2 gap-[4px] w-[90px]  justify-center rounded-md  flex-col" >
            ...
            {label == "Home" ? <div  className='bg-red-700 h-[8px] mx-auto  rounded-t-md'></div>: null}
        </div>
    )
}
...
function BottomNav() {
  return (
    <div className="bg-white lg-sm:hidden color-red-700 max-sm:fixed bottom-0 shadow-xl rounded-t-[15px] border-solid border-2 border-t-black border-x-black h-[90px] flex justify-between items-center px-6 w-full">
