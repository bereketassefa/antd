...
export default function DropMenu({isOpen,onClose,image,name}) {
  ...
  return (
    <div className={`${isOpen ? ' z-200 w-screen h-[calc(100vh-0px)] bg-gray-50 p-4 fixed mt-[0px] md:hidden flex flex-col gap-2 z-3 overflow-y-scroll ' :
     'w-screen  bg-gray-50 p-4  absolute  mt-[65px]  md:hidden flex flex-col gap-2 hidden '}`}>
