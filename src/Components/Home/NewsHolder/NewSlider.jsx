    ...
    <div className="relative flex justify-between gap-16">
      <div className="relative">
        ...
        <div className="w-full relative">
          <img
            src={image}
            className="w-[1000px] h-[600px] object-cover rounded-lg"
          />

          <div className="absolute bottom-0  justify-center mx-96   bg-black bg-opacity-50 text-white p-4">
      ...
      <div className="absolute -right-[100px] -top-8  h-14   ">
        <AiOutlineClose
          className="w-[50px] h-[50px] rounded-full text-white p- flex justify-end bg-zinc-700"
          onClick={handleClose}
        />
      </div>
    </div>
