...
//           <div className="absolute bottom-0  justify-center mx-80   bg-black bg-opacity-50 text-white p-4">
...
//         <AiOutlineClose
//           className="  w-[30px] h-[30px] md:w-[50px] md:h-[50px]  rounded-full text-white p- flex justify-end bg-zinc-700"
//           onClick={handleClose}
//         />
//       </div>
//     </div>
